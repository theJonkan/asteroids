...
/**
 * AbstractRendererComponent helps with the drawing of DisplayableObjects. It draws a black background and all the lines between points in
 * the objects' matrices.
 */
